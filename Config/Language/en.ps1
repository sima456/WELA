...
$Create_LogonTimeline_Welcome_Message = "Creating a logon timeline from the Security log excluding noisy events such as service, system and machine account local logons."
